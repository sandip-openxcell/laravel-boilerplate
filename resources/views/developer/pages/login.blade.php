...
<body class="flex h-screen bg-black">
	<div class="w-full max-w-sm m-auto bg-white rounded p-5">
      	<header>
        	<img class="w-40 mx-auto mb-5" src="{{ asset('assets/img/logo.svg') }}" />
      	</header>
    	<div class="mt-1 mb-4">
        ...
        @endif
      	<form method="POST" action="{{ route('developer.login') }}" class="mt-45px">
	        ...
	        <div>
	          	<input class="w-98 bg-black-600 text-white font-bold py-2 px-4 mb-6 rounded b-none" type="submit" value="Login">
	        </div>
      	</form>
    </div>
</body>
